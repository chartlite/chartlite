    ...
    <div className="max-w-6xl mx-auto">
      ...
      <header className="text-center mb-16">
        ...
        <p className="text-lg text-white/80 max-w-3xl mx-auto mb-8">
          A high-performance charting library with zero dependencies. Beautiful
          charts in ~39KB (5-10x smaller than alternatives). Fast by default
        ...
        <div className="flex justify-center gap-6 flex-wrap mb-12">
          <div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-full">
            <span className="text-white font-semibold">📦 39KB</span>
          </div>
          <div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-full">
            <span className="text-white font-semibold">⚡ Fast by Default</span>
          </div>
          <div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-gray-600">
            Explore LineChart, BarChart, and AreaChart with different themes and
            configurations.
          </p>
        ...
        >
          ...
          <p className="text-gray-600">
            Multiple datasets on one chart with legends, grouped bars, and
            stacked areas.
          </p>
        ...
        >
          ...
          <p className="text-gray-600">
            See all 4 supported data formats: DataPoint[], number[],
            column-oriented, and series-first.
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-gray-600">
            Scatter charts with point labels, different shapes, and multi-series
            support.
          </p>
          <span className="inline-block mt-4 px-4 py-2 bg-green-100 text-green-700 text-sm font-semibold rounded-full">
            NEW
        ...
        >
          ...
          <p className="text-gray-600">
            See automatic optimizations in action. 42% faster updates,
            auto-sampling, zero configuration.
          </p>
        ...
        >
          ...
          <p className="text-gray-600">
            Add context with thresholds, goals, annotations, and region
            highlighting.
          </p>
          <span className="inline-block mt-4 px-4 py-2 bg-green-100 text-green-700 text-sm font-semibold rounded-full">
            NEW
      ...
      <div className="mt-16 bg-white rounded-2xl p-12 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              42% faster updates, auto-sampling at 500+ points. Zero
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Built with accessibility in mind. WCAG 2.1 AA compliance coming in
              Phase 3.
            </p>
          </div>
        </div>
      ...
      <footer className="mt-16 text-center text-white/80">
        <p className="mb-4">
          &copy; 2025 Chartlite. Open source under MIT License.
        </p>
